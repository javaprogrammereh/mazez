...
public class ItemAdapter_recycler_modern extends RecyclerView.Adapter<ItemAdapter_recycler_modern.MyViewHolder> {
    List<Item_recycler> itemList;
    Context mContext;
    public static boolean flag_recycler_modern=false;
    public ItemAdapter_recycler_modern(List<Item_recycler> itemList, Context mContext){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.aAvatar2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                flag_recycler_modern=true;
                Intent intent  = new Intent(mContext, tozihat.class);
                intent.putExtra("title_modern",itemList.get(position).getuName());
                intent.putExtra("image_modern",itemList.get(position).getuAvatar());
                intent.putExtra("mavad_modern",itemList.get(position).getMavad());
                intent.putExtra("tahaieh_modern",itemList.get(position).getTahaieh());
